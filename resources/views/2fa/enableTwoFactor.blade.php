			...
			<div class="row" style="min-height:710px;">
			   ...
			   <div class="col-lg-12" style="margin-top: 30px;">
					<div class="panel panel-info">
						<div class="panel-heading">2-Step Verification (OTP)</div><!-- 2단계 인증 (OTP) -->
						<div class="panel-body text-center">
        <p>로그인 및 입출금 할 때 OTP앱으로 2단계 인증합니다.</p>
        <p class="text-primary">입출금시 휴대폰 인증 번호 대신 OTP 인증번호를 사용하게 됩니다.</p>
